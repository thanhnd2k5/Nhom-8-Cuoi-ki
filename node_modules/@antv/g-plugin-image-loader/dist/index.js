...
IMAGE_CACHE.onRefAdded = function onRefAdded(ref) {
  var _this = this;
  ref.addEventListener(gLite.ElementEvent.DESTROY, function () {
...
var ImagePool = /*#__PURE__*/function () {
  ...
  return _createClass(ImagePool, [{
    ...
    value: function getOrCreateImage(src, ref) {
      var _this2 = this;
      var imageSource = util.isString(src) ? src : src.src;
      if (!util.isString(src) && !IMAGE_CACHE.has(imageSource)) {
        var imageCache = {
          img: src,
            ...
            case 2:
              ...
              ImageSlicer.api = {
                ...
                createCanvas: function createCanvas() {
                  return gLite.OffscreenCanvasCreator.createCanvas();
                }
              };
    ...
    value: function releaseImage(src, ref) {
      IMAGE_CACHE.release(util.isString(src) ? src : src.src, ref);
    }
  }, {
    key: "releaseImageRef",
    ...
    value: function getOrCreateGradient(params, context) {
      ...
      if (type === gLite.GradientType.LinearGradient) {
        var _computeLinearGradien = gLite.computeLinearGradient(min, width, height, angle),
        ...
        var _computeRadialGradien = gLite.computeRadialGradient(min, width, height, cx, cy, size),
...
ImagePool.isSupportTile = !!gLite.OffscreenCanvasCreator.createCanvas();
    ...
    value: function apply(context) {
      ...
      var handleAttributeChanged = function handleAttributeChanged(e) {
        ...
        var attrName = e.attrName,
          ...
          newValue = e.newValue;
        if (object.nodeName !== gLite.Shape.IMAGE || attrName !== 'src') {
          return;
        }
